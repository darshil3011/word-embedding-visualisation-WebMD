...
st.text('''A word embedding is a learned numeric representation for text where words that have the same meaning have a similar representation. It is this approach to representing words and documents that makes it easier for machines to interpret human languages.''')
